    ...
    components: {
      schemas: {
        ...
        Contact: {
          ...
          properties: {
            id: { type: "string", format: "uuid", description: "ID do contato" },
            ...
            empresa: { type: "string", nullable: true, description: "Nome da empresa" },
            segmento: { type: "string", nullable: true, description: "Segmento/indústria" },
            source: { type: "string", nullable: true, description: "Origem (instagram, whatsapp, facebook, manual)" },
            tags: { type: "array", items: { type: "string" }, nullable: true, description: "Tags" },
            custom_fields: { type: "object", nullable: true, description: "Campos customizados" },
            company_id: { type: "string", format: "uuid", description: "ID da empresa" },
            created_at: { type: "string", format: "date-time" },
